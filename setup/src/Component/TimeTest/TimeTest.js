...
export default function TimeTest() {
  ...
  console.log(momentzz(timeTemp).tz("America/New_York").format('YYYY-MM-DD HH:mm:ss'));
  console.log(momentzz(timeTemp).tz("Asia/Shanghai").format('YYYY-MM-DD HH:mm:ss'));
  ...
  console.log(moment.tz(timeTemp,"America/New_York").format('YYYY-MM-DD HH:mm:ss'))
  console.log(moment.tz(timeTemp,"Asia/Shanghai").format('YYYY-MM-DD HH:mm:ss'))
  ...
  console.log(moment.tz(timeStr,"America/New_York").format('YYYY-MM-DD HH:mm:ss'))
  console.log(moment.tz(timeStr,"Asia/Shanghai").format('YYYY-MM-DD HH:mm:ss'))

  // 这个案例意思是：把纽约的2022-12-17 21:00:00的时间戳，创建为上海的时间(上海在纽约这个时间为：2022-12-18 10:00:00，因为上海比纽约快13小时)
  console.log(moment.tz(moment.tz(timeStr,"America/New_York").valueOf(),"Asia/Shanghai").format('YYYY-MM-DD HH:mm:ss'))
  console.log(moment.tz(moment.tz(timeStr,"Asia/Shanghai").valueOf(),"Asia/Shanghai").format('YYYY-MM-DD HH:mm:ss'))
